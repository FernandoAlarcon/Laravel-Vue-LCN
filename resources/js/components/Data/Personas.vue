                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr v-for="( Persona, index ) of Personas" :key="index" >
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium"> 
                                        <button 
                                            v-on:click.prevent="DeleteData(Persona)"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium"> 
                                        <button 
                                            v-on:click.prevent="AbrirModalUpdate(Persona)"
                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full px-3">
                                        ...
                                        <input  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                                ...
                                                v-model="NuevaData.identificacion"
                                                required
                                        /> 
                                    </div>
                                </div> 
                                    ...
                                    <div class="w-full md:w-1/2 px-4 mb-6 md:mb-0">
                                        ...
                                        <div class="relative">
                                            ...
                                            <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" 
                                                    id="grid-state" 
                                                    required
                                                    v-model="NuevaData.tipos_identificacion  ">
                                ...
                                <div class="flex flex-wrap -mx-3 mb-6">
                                    <div class="w-full px-3">
                                        ...
                                        <input  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                                ...
                                                type="date"
                                                placeholder="Identificacion" 
                                                v-model="NuevaData.fecha_nacimiento"
                                                required
                                        /> 
                                    </div>
                                </div>
    ...
    export default {
        ...
        methods: { 
            ...
            getData: function(page){
                ...
                var URL_BASE =  this.Ruta + '?page=' + page + '&data=' + this.DataSend ;
            ...
            CrearData: function(){
                ...
                if (    
                        this.NuevaData.nombres                 == ''  ||
                        this.NuevaData.apellidos               == ''  ||
                        this.NuevaData.tipos_identificacion    == ''  ||
                        this.NuevaData.identificacion          == ''  ||
                        this.NuevaData.sexo                    == ''  ||
                        this.NuevaData.fecha_nacimiento        == ''  ||
                        this.NuevaData.carrera                 == ''
                    )
                {
            ...
            DeleteData: function(Data){
                ...
                swal({
                title: "Estas seguro ?",
                text: "Vas a eliminar a " + Data.nombres + " " + Data.apellidos + ", perderas este registro",
                icon: "warning",
                buttons: true,
                dangerMode: true,
                })
                ...
                if (willDelete) {
                    let IdData = Data.id;
                        axios.delete(URL_BASE + IdData).then( () => {
                            this.getData();
                            swal("Eliminaste a " + Data.nombres + " " + Data.apellidos + " de la base de datos", {
                                icon: "success",
                            }); 
                    }).catch(error=>{
                        alert("Error "+error)
            ...
            UpdateData: function(){
               ...
               var URL_BASE = this.Ruta + '/' + this.NuevaData.id;
                ...
                text: "Vas a actualizar a " + this.NuevaData.nombres + " " + this.NuevaData.apellidos + ", cambiaras este registro",
                icon: "warning",
                buttons: true,
                dangerMode: true,
                })
                .then((willDelete) => {
                    if (willDelete) {
                            ...
                            axios.put(URL_BASE,this.NuevaData).then( () =>{
                                ...
                                swal("Actualizaste la Categoria " + Data.nombres  + " de la base de datos", {
                                    icon: "success",
                                }); 
            ...
            AbrirModalUpdate: function(UpdateData){
                ...
                this.NuevaData.nombres           = UpdateData.nombres;
                this.NuevaData.apellidos         = UpdateData.apellidos;
                this.NuevaData.tipos_identificacion           = UpdateData.tipos_identificacion;
                this.NuevaData.identificacion                 = UpdateData.identificacion;

                this.NuevaData.sexo                          = UpdateData.sexo;
                this.NuevaData.carrera                       = UpdateData.carrera;
                this.NuevaData.fecha_nacimiento              = UpdateData.fecha_nacimiento; 
