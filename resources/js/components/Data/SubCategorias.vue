                    ...
                    <div>
                        <table class="table table-report sm:mt-2">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="( SubCategoria, index ) of SubCategorias" :key="index" >
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        {{SubCategoria.nombresubcategorias}}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        {{SubCategoria.tipogastomensual}}
                                    </td> 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium"> 
                                        <button 
                                            v-on:click.prevent="DeleteData(SubCategoria)"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium"> 
                                        <button 
                                            v-on:click.prevent="AbrirModalUpdate(SubCategoria)"
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    ...
                                    <input  class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
                                            ...
                                            v-model="NuevaData.nombresubcategorias"
                                            />
                                ...
                                <div class="w-full md:w-1/2 px-4 mb-6 md:mb-0">
                                    ...
                                    <div class="relative">
                                        <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" 
                                                id="grid-state" 
                                                v-model="NuevaData.tipogastomensual">
            ...
            getData: function(page){
                ...
                if (this.DataSend != '') {
					axios.get(URL_BASE,{params: {DataSend: this.DataSend}}).then(response=>{
						this.SubCategorias = response.data.subcategorias.data,
            ...
            DeleteData: function(Data){
                ...
                if (willDelete) {
                    let IdData = Data.id;
                        ...
                        this.getData();
                        swal("Eliminaste la Categoria " + Data.nombresubcategorias + " de la base de datos", {
                            icon: "success",
                        }); 
                    }).catch(error=>{
                        alert("Error "+error)
            ...
            UpdateData: function(){
                ...
                if (willDelete) {
                    let IdData = Data.id;
                        ...
                        swal("Actualizaste la Categoria " + Data.nombresubcategorias + " de la base de datos", {
                            icon: "success",
                        }); 
